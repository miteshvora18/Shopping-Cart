<%@ Page Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="ProductDetail.aspx.cs" Inherits="ShoppingCart.ProductDetail" %>

<asp:Content ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div style="width:964px;margin:0 auto;">
        <div id="products">
            <table width="100%" cellpadding="0" cellspacing="0" class="paddingFooter">
                <tr>
                    ...
                    <td>
                        ...
                        <div class="padTop5">
                            ...
                            <asp:Label ID="lblProductBrand" runat="server" Text="" CssClass="lblDetail"></asp:Label>
                        </div>
                        <div class="padTop5">
